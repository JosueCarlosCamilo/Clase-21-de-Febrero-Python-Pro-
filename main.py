...
app = Flask(__name__)
# Conectando SQLite | #base de datos local "///" (tres slash)
...
#name=email y name=password van a ser los datos que van a ser enviados a login
...
def login():
        ...
        if request.method == 'POST':
            ...
            error = 'Nombre de usuario o contraseña incorectos, porfavor registrate'
